      ...
      <footer className="bg-white border-t border-[#E5E7EB] py-14 px-6">
        <div className={container}>
          <div className="grid grid-cols-1 md:grid-cols-5 gap-10 mb-12">
            ...
            {[
              ...
              },
              {
                label: "Integrations",
                links: [
                  { label: "Search Console", href: "/integrations/search-console" },
                  { label: "CSV Upload",     href: "/integrations/csv"            },
                  { label: "Shopify",        href: "/shopify"                     },
          ...
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
            <p className="text-[12px] text-[#9CA3AF]">© 2026 ShowsUp. All rights reserved.</p>
